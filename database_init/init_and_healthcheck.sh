...
create_postgres_databases() {
  psql -U $POSTGRES_USER -d $POSTGRES_DB -c "CREATE DATABASE community_user_service;"
  psql -U $POSTGRES_USER -d $POSTGRES_DB -c "CREATE DATABASE community_post_service;"
  psql -U $POSTGRES_USER -d $POSTGRES_DB -c "CREATE DATABASE community_upload_service;"
}
...
DATABASES=("community_user_service" "community_upload_service" "community_post_service")
